...
export function CareTeamManagement({
  ...
  const fetchAvailableProviders = useCallback(async () => {
    try {
      // Use API route which bypasses RLS and handles errors gracefully
      ...
      console.log("[Care Teams] Loaded providers:", providers.length);
  ...
  const fetchAvailablePatients = useCallback(async () => {
    try {
      ...
      console.log("[Care Teams] Loaded patients:", {
        total: patients.length,
        active: activePatients.length
      });
      setAvailablePatients(activePatients);
    } catch (error) {
  ...
  useEffect(() => {
    console.log("[Care Teams] State update:", {
      providersCount: availableProviders.length,
      patientsCount: availablePatients.length,
      teamsCount: careTeams.length
    });
  }, [availableProviders, availablePatients, careTeams]);
