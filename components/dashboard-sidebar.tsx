  ...
  const baseCategories: NavCategory[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: Brain, label: "Clinical Decision Support", href: "/clinical-decision-support", count: 3 },
    ...
    },
    {
      ...
      items: [
        ...
        { icon: Syringe, label: "Off-Site Dosing Management", href: "/offsite-dosing" },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { icon: Network, label: "MiHIN Integration", href: "/mihin-integration" },
      ],
    },
    {
      label: "Compliance",
