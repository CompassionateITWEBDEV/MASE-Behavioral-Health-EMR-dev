...
import { SkeletonPatientCards } from "@/components/ui/skeleton-patient-card";
import type { PatientWithRelations, PatientRiskLevel } from "@/types/patient";
...
export function PatientList({
  ...
  const getPatientRiskLevel = (patient: PatientWithRelations): PatientRiskLevel => {
