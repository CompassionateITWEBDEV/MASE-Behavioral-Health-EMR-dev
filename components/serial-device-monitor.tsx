        ...
        <CardTitle className="flex items-center justify-between">
          ...
          <Badge
            ...
            <div className="flex items-center gap-1">
              {getStatusIcon(deviceStatus?.status || "offline")}
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              {deviceStatus?.bottle_id || "N/A"}
            </p>
          </div>
          <div>
            <p className="font-medium">Remaining Volume</p>
            <p className="text-muted-foreground">
              {deviceStatus?.est_remaining_ml || 0} mL
            </p>
          </div>
          <div>
        ...
        <div className="flex justify-between items-center text-xs text-muted-foreground">
          <span>Firmware: {deviceStatus?.firmware_version || "N/A"}</span>
          <span>Last Update: {lastUpdate?.toLocaleTimeString() || "N/A"}</span>
        </div>
