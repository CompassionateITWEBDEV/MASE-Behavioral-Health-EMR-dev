                      ...
                      <TableRow key={prescription.id}>
                        <TableCell className="font-medium">
                          <div className="flex flex-col gap-1">
                            ...
                            {prescription.patientTransferred && (
                              <Badge variant="outline" className="w-fit text-xs bg-orange-50 text-orange-700 border-orange-200">
                                <AlertCircle className="h-3 w-3 mr-1" />
                                Transferred {prescription.transferredTo ? `to ${prescription.transferredTo}` : ""}
                              </Badge>
                            )}
                          </div>
                        </TableCell>
              ...
              <SelectContent>
                ...
                {filteredPatients.length === 0 ? (
                  ...
                  filteredPatients.map((patient, index) => {
                    const dobText = patient.date_of_birth ? ` (DOB: ${new Date(patient.date_of_birth).toLocaleDateString()})` : ''
                    const displayText = `${patient.first_name} ${patient.last_name}${dobText}`
                    return (
                      <SelectItem key={patient.id || `patient-${index}-${patient.first_name}-${patient.last_name}`} value={patient.id}>
                        {displayText}
                      </SelectItem>
                    )
                  })
            ...
            <SelectContent>
              {medications.length > 0 ? (
                medications.map((med, index) => {
                  const displayText = med.strength ? `${med.name} - ${med.strength}` : med.name
                  return (
                    <SelectItem key={med.id || `med-${index}-${med.name}`} value={med.name}>
                      {displayText}
                    </SelectItem>
                  )
                })
                ...
                <>
                  <SelectItem key="methadone" value="Methadone">Methadone</SelectItem>
                  <SelectItem key="buprenorphine" value="Buprenorphine">Buprenorphine</SelectItem>
                  <SelectItem key="buprenorphine-naloxone" value="Buprenorphine/Naloxone">Buprenorphine/Naloxone (Suboxone)</SelectItem>
                  <SelectItem key="naltrexone" value="Naltrexone">Naltrexone</SelectItem>
                  <SelectItem key="naltrexone-er" value="Naltrexone ER">Naltrexone ER (Vivitrol)</SelectItem>
                  <SelectItem key="clonidine" value="Clonidine">Clonidine</SelectItem>
                  <SelectItem key="gabapentin" value="Gabapentin">Gabapentin</SelectItem>
                  <SelectItem key="hydroxyzine" value="Hydroxyzine">Hydroxyzine</SelectItem>
                </>
              )}
            </SelectContent>
          </Select>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Select value={formData.refills} onValueChange={(value) => setFormData({ ...formData, refills: value })}>
            ...
            <SelectContent>
              <SelectItem key="refills-0" value="0">0</SelectItem>
              <SelectItem key="refills-1" value="1">1</SelectItem>
              <SelectItem key="refills-2" value="2">2</SelectItem>
              <SelectItem key="refills-3" value="3">3</SelectItem>
              <SelectItem key="refills-4" value="4">4</SelectItem>
              <SelectItem key="refills-5" value="5">5</SelectItem>
            </SelectContent>
          </Select>
        </div>
              ...
              <SelectContent>
                {pharmacies.length > 0 ? (
                  pharmacies.map((pharmacy, index) => {
                    const displayText = pharmacy.address ? `${pharmacy.name} - ${pharmacy.address}` : pharmacy.name
                    return (
                      <SelectItem key={pharmacy.id || `pharmacy-${index}-${pharmacy.name}`} value={pharmacy.id}>
                        {displayText}
                      </SelectItem>
                    )
                  })
                  ...
                  <>
                    <SelectItem key="pharmacy-cvs" value="cvs">CVS Pharmacy</SelectItem>
                    <SelectItem key="pharmacy-walgreens" value="walgreens">Walgreens</SelectItem>
                    <SelectItem key="pharmacy-riteaid" value="riteaid">Rite Aid</SelectItem>
                    <SelectItem key="pharmacy-walmart" value="walmart">Walmart Pharmacy</SelectItem>
                    <SelectItem key="pharmacy-onsite" value="onsite">On-site Dispensary</SelectItem>
                  </>
                )}
              </SelectContent>
            </Select>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Select value={drug1} onValueChange={setDrug1}>
              ...
              <SelectContent>
                <SelectItem key="drug1-methadone" value="methadone">Methadone</SelectItem>
                <SelectItem key="drug1-buprenorphine" value="buprenorphine">Buprenorphine</SelectItem>
                <SelectItem key="drug1-naltrexone" value="naltrexone">Naltrexone</SelectItem>
                <SelectItem key="drug1-benzodiazepines" value="benzodiazepines">Benzodiazepines</SelectItem>
                <SelectItem key="drug1-gabapentin" value="gabapentin">Gabapentin</SelectItem>
                <SelectItem key="drug1-clonidine" value="clonidine">Clonidine</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div>
            ...
            <Select value={drug2} onValueChange={setDrug2}>
              ...
              <SelectContent>
                <SelectItem key="drug2-methadone" value="methadone">Methadone</SelectItem>
                <SelectItem key="drug2-buprenorphine" value="buprenorphine">Buprenorphine</SelectItem>
                <SelectItem key="drug2-naltrexone" value="naltrexone">Naltrexone</SelectItem>
                <SelectItem key="drug2-benzodiazepines" value="benzodiazepines">Benzodiazepines</SelectItem>
                <SelectItem key="drug2-gabapentin" value="gabapentin">Gabapentin</SelectItem>
                <SelectItem key="drug2-clonidine" value="clonidine">Clonidine</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
