                      ...
                      <CardContent className="pt-6">
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                          <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                              <Input
                                ...
                                value={vitals.systolic_bp != null ? String(vitals.systolic_bp) : ""}
                                onChange={(e) => {
                              ...
                              <Input
                                ...
                                value={vitals.diastolic_bp != null ? String(vitals.diastolic_bp) : ""}
                                onChange={(e) => {
                                  const value = e.target.value
                                  setVitals((prev) => ({
                                    ...prev,
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              type="number"
                              value={vitals.heart_rate != null ? String(vitals.heart_rate) : ""}
                              onChange={(e) => {
                                const value = e.target.value
                                setVitals((prev) => ({
                                  ...prev,
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              type="number"
                              value={vitals.respiratory_rate != null ? String(vitals.respiratory_rate) : ""}
                              onChange={(e) => {
                                const value = e.target.value
                                setVitals((prev) => ({
                                  ...prev,
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                              ...
                              />
                              <Select
                                value={vitals.temperature_site || "oral"}
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              type="number"
                              value={vitals.oxygen_saturation != null ? String(vitals.oxygen_saturation) : ""}
                              onChange={(e) => {
                                const value = e.target.value
                                setVitals((prev) => ({
                                  ...prev,
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                              <Input
                                type="number"
                                step="0.1"
                                value={vitals.weight != null ? String(vitals.weight) : ""}
                                onChange={(e) => {
                                  const value = e.target.value
                                  setVitals((prev) => ({
                                    ...prev,
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                              <Input
                                type="number"
                                placeholder="ft"
                                value={vitals.height_feet != null ? String(vitals.height_feet) : ""}
                                onChange={(e) => {
                                  const value = e.target.value
                                  setVitals((prev) => ({
                                    ...prev,
                              ...
                              <Input
                                type="number"
                                placeholder="in"
                                value={vitals.height_inches != null ? String(vitals.height_inches) : ""}
                                onChange={(e) => {
                                  const value = e.target.value
                                  setVitals((prev) => ({
                                    ...prev,
                          ...
                          <div className="space-y-2">
                            ...
                            <Input type="number" value={vitals.bmi ? String(vitals.bmi) : ""} readOnly className="bg-muted" />
                          </div>
                        </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex gap-2 items-center">
                              <Input
                                ...
                                min="0"
                                max="10"
                                value={vitals.pain_scale != null ? String(vitals.pain_scale) : ""}
                                onChange={(e) => {
                                  const value = e.target.value
                                  setVitals((prev) => ({
                                    ...prev,
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2">
                            <Input
                              type="number"
                              placeholder="Systolic"
                              value={editingVitals.systolic_bp != null ? String(editingVitals.systolic_bp) : ""}
                              onChange={(e) => {
                                const value = e.target.value
                            ...
                            <Input
                              type="number"
                              placeholder="Diastolic"
                              value={editingVitals.diastolic_bp != null ? String(editingVitals.diastolic_bp) : ""}
                              onChange={(e) => {
                                const value = e.target.value
                                setEditingVitals((prev) => ({
                                  ...prev,
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            type="number"
                            placeholder="HR"
                            value={editingVitals.heart_rate != null ? String(editingVitals.heart_rate) : ""}
                            onChange={(e) => {
                              const value = e.target.value
                              setEditingVitals((prev) => ({
                                ...prev,
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            type="number"
                            placeholder="RR"
                            value={editingVitals.respiratory_rate != null ? String(editingVitals.respiratory_rate) : ""}
                            onChange={(e) => {
                              const value = e.target.value
                              setEditingVitals((prev) => ({
                                ...prev,
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            step="0.1"
                            placeholder="Temp"
                            value={editingVitals.temperature != null ? String(editingVitals.temperature) : ""}
                            onChange={(e) => {
                              const value = e.target.value
                              setEditingVitals((prev) => ({
                                ...prev,
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            type="number"
                            placeholder="O2 Sat"
                            value={editingVitals.oxygen_saturation != null ? String(editingVitals.oxygen_saturation) : ""}
                            onChange={(e) => {
                              const value = e.target.value
                              setEditingVitals((prev) => ({
                                ...prev,
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            step="0.1"
                            placeholder="Weight"
                            value={editingVitals.weight != null ? String(editingVitals.weight) : ""}
                            onChange={(e) => {
                              const value = e.target.value
                              setEditingVitals((prev) => ({
                                ...prev,
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2">
                            <Input
                              type="number"
                              placeholder="Feet"
                              value={editingVitals.height_feet != null ? String(editingVitals.height_feet) : ""}
                              onChange={(e) => {
                                const value = e.target.value
                                setEditingVitals((prev) => ({
                                  ...prev,
                            ...
                            <Input
                              type="number"
                              placeholder="Inches"
                              value={editingVitals.height_inches != null ? String(editingVitals.height_inches) : ""}
                              onChange={(e) => {
                                const value = e.target.value
                                setEditingVitals((prev) => ({
                                  ...prev,
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            max="10"
                            placeholder="Pain"
                            value={editingVitals.pain_scale != null ? String(editingVitals.pain_scale) : ""}
                            onChange={(e) => {
                              const value = e.target.value
                              setEditingVitals((prev) => ({
                                ...prev,
