      ...
      prev.map((f) => {
        if (f.id === featureId) {
          ...
          const currentTierLevel =
            tierOrder[currentPlan as keyof typeof tierOrder];
          const featureTierLevel = tierOrder[f.tier as keyof typeof tierOrder];
          ...
          <Dialog
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  Enter practice information and credentials to configure agency
                  setup
                </DialogDescription>
              </DialogHeader>

              <form
                onSubmit={handlePracticeOnboarding}
