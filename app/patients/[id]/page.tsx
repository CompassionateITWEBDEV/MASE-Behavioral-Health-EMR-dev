...
export default function PatientChartPage({
  ...
  const patientData = {
    ...
    status: "Active",
    alerts: patient.appointments?.some(
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1">
                    ...
                    {patientData.program.type} Program
                  </p>
                </div>
              </div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          value={patientData.insurance.memberId}
                          readOnly
                        />
                      </div>
                      <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          value={patientData.insurance.effectiveDate}
                          readOnly
                        />
                      </div>
                      <div className="space-y-2">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          value={patientData.program.currentDose}
                          readOnly
                        />
                      </div>
                      <div className="space-y-2">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          value={patientData.asam.assessmentDate}
                          readOnly
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          value={patientData.asam.nextAssessment}
                          readOnly
                        />
                      </div>
                    </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex justify-between items-center p-3 border border-border rounded-lg">
                          ...
                          <Badge variant="secondary">
                            {patientData.asam.criteria.dimension1}
                          </Badge>
                        </div>
                        <div className="flex justify-between items-center p-3 border border-border rounded-lg">
                          <span className="text-sm">
                          ...
                          <Badge variant="outline">
                            {patientData.asam.criteria.dimension2}
                          </Badge>
                        </div>
                        <div className="flex justify-between items-center p-3 border border-border rounded-lg">
                          <span className="text-sm">
                          ...
                          <Badge variant="secondary">
                            {patientData.asam.criteria.dimension3}
                          </Badge>
                        </div>
                        <div className="flex justify-between items-center p-3 border border-border rounded-lg">
                          <span className="text-sm">
                          ...
                          <Badge variant="outline">
                            {patientData.asam.criteria.dimension4}
                          </Badge>
                        </div>
                        <div className="flex justify-between items-center p-3 border border-border rounded-lg">
                          <span className="text-sm">
                          ...
                          <Badge variant="secondary">
                            {patientData.asam.criteria.dimension5}
                          </Badge>
                        </div>
                        <div className="flex justify-between items-center p-3 border border-border rounded-lg">
                          <span className="text-sm">
                          ...
                          <Badge variant="outline">
                            {patientData.asam.criteria.dimension6}
                          </Badge>
                        </div>
                      </div>
                    </div>
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="space-y-2 mt-4">
                        ...
                        <Select>
                          ...
                          <SelectContent>
                            <SelectItem value="suicide-risk">
                              Suicide Risk
                            </SelectItem>
                            <SelectItem value="relapse-risk">
                              Relapse Risk
                            </SelectItem>
                            <SelectItem value="violence-risk">
                              Violence Risk
                            </SelectItem>
                            <SelectItem value="non-compliance">
                              Non-compliance
                            </SelectItem>
                            <SelectItem value="missed-appointment">
                              Missed Appointment
                            </SelectItem>
                            <SelectItem value="dose-adjustment">
              ...
              <TabsContent value="notes" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Recent documentation and progress notes
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="consents" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Required consent forms for OTP treatment program
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    {[
                      {
                        name: "Informed Consent for MAT",
                        status: "Completed",
                        date: "2024-01-15",
                        required: true,
                      },
                      ...
                      {
                        name: "Methadone Treatment Consent",
                        status: "Completed",
                        date: "2024-01-15",
                        required: true,
                      },
                      {
                        name: "Urine Testing Consent",
                        status: "Completed",
                        date: "2024-01-15",
                        required: true,
                      },
                      {
                        name: "Take-Home Medication Agreement",
                        status: "Pending",
                        date: null,
                        required: true,
                      },
                      {
                        name: "Photography/Recording Consent",
                        status: "Declined",
                        date: "2024-01-15",
                        required: false,
                      },
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              ...
                              {consent.date && `• Signed: ${consent.date}`}
                            </p>
                          </div>
                        </div>
                        <div className="flex gap-2">
              ...
              <TabsContent value="documents" className="space-y-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      {[
                        ...
                        {
                          name: "Court Order - Treatment",
                          type: "Legal",
                          date: "2024-01-10",
                          size: "1.8 MB",
                        },
                        {
                          name: "Previous Treatment Records",
                          type: "Medical",
                          date: "2024-01-08",
                          size: "5.2 MB",
                        },
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      {[
                        {
                          name: "Dose Adjustment Log - Q1 2024",
                          date: "2024-03-31",
                          size: "1.2 MB",
                        },
                        {
                          name: "Take-Home Schedule",
                          date: "2024-01-15",
                          size: "0.5 MB",
                        },
                        {
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Upload patient documents, court orders, transfer records,
                      ...
                      <div className="space-y-2">
                        ...
                        <Select>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="dose-history">
                              Dose History
                            </SelectItem>
                            <SelectItem value="court-order">
                              Court Order
                            </SelectItem>
