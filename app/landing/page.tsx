...
export default function LandingPage() {
  ...
  const loginOptions = [
    ...
    },
    {
      ...
      description: "Manage your practice settings",
      icon: Building2,
    ...
    },
    {
      ...
      description: "Physicians, NPs, PAs",
      icon: Stethoscope,
    ...
    },
    {
      ...
      description: "Nurses, MAs, counselors",
      icon: UserCog,
    ...
    },
    {
      ...
      description: "MAT, methadone, buprenorphine",
      icon: Syringe,
      href: "/auth/otp-login",
      color: "bg-rose-500",
    },
    {
      title: "PT/OT/SLP Portal",
    ...
    {
      title: "Recipient Rights Officer",
      description: "Complaint management and investigation",
      icon: Shield,
    ...
    },
    {
      ...
      description: "Incident reporting and crisis response",
      icon: ShieldAlert,
