...
export default function PatientVerifyDosePage() {
  ...
  const captureBiometric = async () => {
    ...
    if (!isWithinDosingWindow()) {
      setStep("failed");
      setErrorMessage(
        "Dosing window has closed. Please contact your clinic immediately."
      );
      return;
    }
      ...
      <div className="max-w-lg mx-auto p-4 space-y-4">
        ...
        {!isWithinDosingWindow() ? (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              The dosing window (6:00 AM - 11:00 AM) has passed. Please contact
          ...
          <Alert style={{ backgroundColor: "#1e3a5f", borderColor: "#0891b2" }}>
            ...
            <AlertTitle style={{ color: "#e0f2fe" }}>
              Dosing Window Open
            </AlertTitle>
            <AlertDescription style={{ color: "#94a3b8" }}>
              {timeRemaining} to verify your dose
            </AlertDescription>
          </Alert>
        )}
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <div
                ...
                style={{
                  backgroundColor: step !== "scan" ? "#22c55e" : "#334155",
                }}
              />
              <div className="flex flex-col items-center">
                <div
              ...
              <div
                className="flex-1 h-1 mx-2"
                style={{
                  backgroundColor: ["biometric", "success"].includes(step)
                    ? "#22c55e"
                    : "#334155",
                }}
              />
              ...
              <div
                className="flex-1 h-1 mx-2"
                style={{
                  backgroundColor: step === "success" ? "#22c55e" : "#334155",
                }}
              />
              <div className="flex flex-col items-center">
                <div
            ...
            <CardContent className="flex flex-col items-center">
              <div
                ...
                {isScanning ? (
                  <div className="text-center">
                    <Loader2
                      className="h-12 w-12 animate-spin mx-auto mb-2"
                      style={{ color: "#0891b2" }}
                    />
                ...
                <div
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm" style={{ color: "#94a3b8" }}>
                        Bottle {bottleData.bottle_number} of{" "}
                        {bottleData.total_bottles}
                      </p>
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      ...
                      <p className="text-white font-mono text-xs">
                        {bottleData.bottle_id}
                      </p>
                    </div>
                    <div>
                      <p style={{ color: "#64748b" }}>Expected Date</p>
                      <p className="text-white">
                        {bottleData.expected_consumption_date}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <CardContent className="flex flex-col items-center">
              <div
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <div
                    className="w-40 h-48 border-2 border-dashed rounded-full"
                    style={{ borderColor: "#0891b2" }}
                  />
                </div>
                {isCapturing && (
          ...
          <Card style={{ backgroundColor: "#1e293b", borderColor: "#22c55e" }}>
            <CardContent className="p-8 text-center">
              ...
              <p style={{ color: "#94a3b8" }} className="mb-6">
                Your take-home dose has been successfully verified. You may now
            ...
            <CardContent className="p-8 text-center">
              ...
              <Alert variant="destructive" className="text-left mb-6">
                ...
                <AlertDescription>
                  Call: (555) 123-4567
                  <br />
                  This incident has been logged and your counselor has been
                  notified.
                </AlertDescription>
              </Alert>
