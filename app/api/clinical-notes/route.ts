...
export async function POST(request: Request) {
  try {
    ...
    const { patient_id, note_type, subjective, objective, assessment, plan, provider_id, note_date } = body
    ...
    // The note_date parameter is accepted but not stored separately
