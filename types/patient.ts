 ...
 * Patient status type
 */
export type PatientStatus = "active" | "inactive" | "discharged" | "intake" | "on-hold"
 ...
 */
export function formDataToPatient(formData: PatientFormData, id?: string): Partial<Patient> {
  return {
    ...(id && { id }),
